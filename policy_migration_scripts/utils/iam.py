...
from policy_migration_scripts.utils.constants import MAX_PAGE_ITEMS, MEMBER_ACCOUNT_ROLE_NAME
...
class IamHelper:
    ...
    @staticmethod
    def get_customer_managed_policies(iam_client_, max_items_=MAX_PAGE_ITEMS):
        marker = None
        while True:
    ...
    @staticmethod
    def get_users(iam_client_, max_items_=MAX_PAGE_ITEMS):
        marker = None
        while True:
    ...
    @staticmethod
    def get_roles(iam_client_, max_items_=MAX_PAGE_ITEMS):
        marker = None
        while True:
    ...
    @staticmethod
    def get_groups(iam_client_, max_items_=MAX_PAGE_ITEMS):
        marker = None
        while True:
